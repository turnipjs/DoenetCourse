...
$sql = "SELECT a.assignmentId AS assignmentId,
        ...
        ON uaa.assignmentId = a.assignmentId
            AND uaa.username = '$remoteuser'
            AND uaa.attemptNumber = (
...
if ($result->num_rows > 0){
    while($row = $result->fetch_assoc()){
        ...
        if ($prev_headingId != $row["courseHeadingId"]){
            ...
            array_push($headingId_arr,$row["courseHeadingId"]);
        }
        
        $prev_headingId = $row["courseHeadingId"];
    }
} 
